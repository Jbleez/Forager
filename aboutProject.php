			...
			<img src="images/metal.jpg" />
				<div class="wrapper"><!-- wrapper needed for scroll -->
					...
					<blockquote cite="http://www.gutenberg.org/ebooks/1257">
						<p>The project here<br/> Just go through the website <br/> Or ask the professor for more details</p>
					</blockquote>
					<div class="mb-attribution">
						<p class="mb-author">Scrum Warriors</p>
						 <cite>
						 <?php if(isset($_GET['user'])){echo '<a href="login.php?userAbout='.urlencode($myUser).'"> Go home </a>';}else
