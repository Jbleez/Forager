<?php
if(isset($_GET['userCrawl']))
{
	$myUser = $_GET['userCrawl'];
...
ul.nav li a:hover {
		...
		<div id="perspective" class="perspective effect-airbnb">
			...
			<img src="images/metal.jpg" />
				<div class="wrapper"><!-- wrapper needed for scroll -->
					...
					<div class="column column1 printHide">
						<p><button id="showMenu"><span class="symbol printHide">&#0067; </span></button></p>

						<div class="navbox printHide">
							<ul class="nav">
							<form action="" method="post">
							<li><a href="#">Stop the crawler</a></li>
							<li><a href="#">Rescan a page</a></li>
							<li><a href="printTheReport.html" target="_blank">Print the report</a></li>
	...
	<div id="controls">
		<div id="perpage">
			...
			<?php print "<option value=\" $last \" selected=\"selected\">$last</option>" ?>
			</select>
		...
		<div class="text printHide">Displaying Page <span id="currentpage"></span> of <span id="pagelimit"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
		<div class="printHide"> <input type="button" onClick="window.print()" value="Print"/> </div>
		<div class = "printHide"><?php echo '<a style=\"font-size:17px\" href="login.php?userAbout='.urlencode($myUser).'"> Go home </a>';?></div>
  ...
  var sorter = new TINY.table.sorter("sorter");
	...
	sorter.init("table",1);
					...
					<p><div id= "footer" class="printHide"> 
